...
def _validate_architecture() -> None:
    required = {
        ...
        "docs/adr/0011-explicit-provider-invocation.md",
        ...
        "docs/adr/0016-immutable-release-bundle.md",
        "docs/adr/0017-public-release-acceptance.md",
        ...
        "docs/adr/0022-verified-simulation-profiles.md",
        "docs/adr/0023-portable-package-consumption.md",
        "docs/adr/0024-dependency-closed-package-consumption.md",
        "docs/adr/0025-composed-package-simulation.md",
        "docs/adr/0026-composed-package-matrix.md",
        ...
        "tests/test_composed_package_matrix.py",
        "docs/releases.md",
        "pyproject.toml",
        ...
        "src/openrtl/adapters/verified_simulation.py",
        "src/openrtl/adapters/portable_catalog.py",
        "src/openrtl/adapters/package_closure.py",
        ...
        "src/openrtl/adapters/provider_invocation.py",
        "src/openrtl/adapters/provider_qualification.py",
        "src/openrtl/adapters/qualified_provider_application.py",
        "src/openrtl/adapters/candidate_promotion.py",
        "src/openrtl/application/expert_edits.py",
        "src/openrtl/application/expert_invocation.py",
        "src/openrtl/application/provider_invocation.py",
        "src/openrtl/application/provider_qualification.py",
        "src/openrtl/application/qualified_provider_application.py",
        "src/openrtl/application/candidate_promotion.py",
        "src/openrtl/application/package_candidates.py",
        ...
        "tests/test_public_release_acceptance.py",
        "tests/test_public_release_v030.py",
        "tests/test_agentrig_compatibility.py",
        ...
        "tools/validate_public_release_v030.py",
        ...
        "tests/test_verified_package_candidates.py",
